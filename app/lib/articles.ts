export const ALL_ARTICLES = [
  {
    ...
    content: `
      <p class="mb-4 text-lg leading-relaxed">Artificial Intelligence is evolving at a rapid pace. As we move into 2024, we are seeing a shift from experimental AI to practical, integrated solutions that businesses use daily.</p>
      <h2 class="text-2xl font-bold mb-4 mt-8">Generative AI Everywhere</h2>
      <p class="mb-4 leading-relaxed">Generative AI tools are becoming ubiquitous, helping creators and developers work faster than ever before. From code generation to image synthesis, the barriers to entry are lowering.</p>
      <h2 class="text-2xl font-bold mb-4 mt-8">Ethical Considerations</h2>
      <p class="mb-4 leading-relaxed">With great power comes great responsibility. The conversation around AI ethics is becoming central to policy making. We need to ensure that these technologies are used to augment human potential, not replace it.</p>
    `
  },
  {
    id: 2,
    ...
    content: `
      <p class="mb-4 text-lg leading-relaxed">Remote work is here to stay. To keep your team aligned, you need the right stack of tools.</p>
      <p class="leading-relaxed">From project management to asynchronous communication, here are our top picks for 2024.</p>
    `
  },
  {
    id: 3,
    ...
    content: `<p class="text-lg">This is a placeholder for the article <strong>understanding-quantum-computing</strong>. In a real application, you would fetch this content from your database.</p>`
  },
  {
    id: 4,
    ...
    content: `<p class="text-lg">This is a placeholder for the article <strong>sustainable-tech-green-gadgets</strong>. In a real application, you would fetch this content from your database.</p>`
  },
  {
    id: 5,
    ...
    content: `<p class="text-lg">This is a placeholder for the article <strong>rise-of-smart-homes</strong>. In a real application, you would fetch this content from your database.</p>`
  },
  {
    id: 6,
    ...
    content: `<p class="text-lg">This is a placeholder for the article <strong>digital-nomad-guide</strong>. In a real application, you would fetch this content from your database.</p>`
  },
  {
    id: 7,
